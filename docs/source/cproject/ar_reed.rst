...
.. note::
   ...
   * You can open the file ``2.9_feel_the_magnetism.ino`` under the path of ``newton-lab-kit/arduino/2.9_feel_the_magnetism``. 
...
..    * You can open the file ``2.9_feel_the_magnetism_irq.ino`` under the path of ``newton-lab-kit/arduino/2.9_feel_the_magnetism_irq``. 
..    * Or copy this code into **Arduino IDE**.
