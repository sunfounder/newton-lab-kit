...
.. note::
    ...
    * Open the ``7.12_digital_bubble_level.py`` file under the path of ``newton-lab-kit/micropython`` or copy this code into Thonny IDE, then click "Run Current Script" or simply press F5 to run it.
