...
#. Open the ``6.5_rfid_write.py`` file under the path of ``newton-lab-kit/micropython``, then click "Run Current Script" or simply press F5 to run it.
...
#. Open the ``7.8_rfid_music_player.py`` file under the path of ``newton-lab-kit/micropython`` or copy this code into Thonny IDE, then click "Run Current Script" or simply press F5 to run it.
