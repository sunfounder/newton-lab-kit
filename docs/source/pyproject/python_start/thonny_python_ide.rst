...
.. note::
    ...
    You can now save the debugged code to your Raspberry Pi Pico by selecting the MicroPython (Raspberry Pi Pico).COMxx interpreter again, clicking the save as button, and clicking the save button again. 
